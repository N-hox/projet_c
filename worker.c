...
void nbrpremier_worker_receive(int tubeCtoW, int data)
{
	recieveDataGeneric(tubeCtoW, data, sizeof(int));
}
...
void nbrPremier_sendResult(int tubeWtoC, bool premier)
	{
		sendDataGeneric(tubeStoC, &premier, sizeof(bool));
	}
...
void loop(/* paramètres */)
{
	...
	nbrpremier_worker_receive(int tubeCtoW, int data);
...
int main(int argc, char * argv[])
{
	...
	nbrPremier_sendResult(int tubeWtoC, true);
